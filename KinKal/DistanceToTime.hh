...
namespace KinKal {
  ...
  class CVDistanceToTime  : public DistanceToTime {
    public:
	...
	dspeed = dvel_;
      ...
      CVDistanceToTime(double s, double tvar, double rcell) :dvel_(s), tvar_(tvar), rcell_(rcell) {}
