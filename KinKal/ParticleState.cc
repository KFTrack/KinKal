...
namespace KinKal {
  using std::string;
  using std::vector;
  vector<string> ParticleState::stateTitles_ = {
    "X Position",
    "Y Position",
    "Z Position",
    "X Momentum",
    "Y Momentum",
    "Z Momentum"};
  vector<string> ParticleState::stateNames_ = { "XPos", "YPos", "ZPos", "XMom", "YMom", "ZMom"};
  vector<string> ParticleState::stateUnits_ = { "mm", "mm", "mm", "MeV/c", "MeV/c", "MeV/c"};
