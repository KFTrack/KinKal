...
namespace KinKal {
  ...
  template <class PTRAJ> class KKHit : public KKWeight<PTRAJ> {
    public:
      ...
      THit const& hit() const { return trkhit_; }
      ...
      virtual ~KKHit(){} 
    private:
      THit const& trkhit_; // hit used for this constraint
      TPOCA<KTRAJ,TLine> tpoca_; // POCA between the reference trajectory and the line returned by the THit
 };
}
#endif
