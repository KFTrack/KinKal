...
namespace KinKal {
  ...
  struct KKConfig {
    ...
    KKConfig(BField const& bfield,std::vector<MConfig>const& schedule) : bfield_(bfield),  maxniter_(10), dwt_(1.0e6), convdchisq_(0.1), divdchisq_(100.0), oscdchisq_(1.0), tbuff_(0.5), dtol_(0.1), ptol_(0.1), minndof_(5), schedule_(schedule), addmat_(true), addbf_(true) {} 
    KKConfig(BField const& bfield) : bfield_(bfield),  maxniter_(10), dwt_(1.0e6), convdchisq_(0.1), divdchisq_(100.0), oscdchisq_(1.0), tbuff_(0.5), dtol_(0.1), ptol_(0.1), bftstep_(0.1),
    minndof_(5), addmat_(true), addbf_(true) {} 
