...
namespace KinKal {
  ...
  class Surface {
    public:
      ...
      // local surface curvature, defined as the maximum 2nd derivative along the surface nearest that point
      ...
      // plane tangent to the surface at the given point.  Direction convention is surface-dependent
      virtual Plane tangentPlane(VEC3 const& point) const  = 0;
  };
}
#endif
