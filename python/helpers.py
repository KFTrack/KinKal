...
#
    def make_dict( self ):
        cmd=self.env.Command('Dict.cc',['HitInfo.hh','BFieldInfo.hh','MaterialInfo.hh','ParticleTrajectoryInfo.hh','LinkDef.h'], 
            'rootcling -f {build}/UnitTests/Dict.cc {src}/UnitTests/HitInfo.hh {src}/UnitTests/MaterialInfo.hh {src}/UnitTests/ParticleTrajectoryInfo.hh {src}/UnitTests/BFieldInfo.hh {src}/UnitTests/LinkDef.h && mv {build}/UnitTests/Dict_rdict.pcm {build}/lib/Dict_rdict.pcm'.format(
